/* Masala Dabba — ordlisteoppslag som Bengal og øst (IN-BEN) innfører, norsk bokmål.
   Nøklene er identiske med content/glossary/bengal.js; `match` er ordformene i den norske teksten. */
...
Object.assign(window.GLOSSARY_NO, {
  ...
  'kosha': {
    term: 'Kosha',
    short: 'Å steke noe langsomt ned med svært lite væske til fettet skiller seg ut.',
    long: 'Dette er en teknikk og ikke en oppskrift. Gryta får tørke ut og begynne å svi seg, en skvett vann løser det brunede laget fra bunnen, og runden gjentas i nesten en time. Hver runde gjør løken et hakk mørkere. Kosha mangsho er geitekjøtt som behandles slik, og navnet beskriver metoden og ikke ingrediensene.',
    match: ['kosha']
  },
  'ilish': {
    term: 'Ilish',
