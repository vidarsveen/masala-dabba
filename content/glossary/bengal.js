/* Masala Dabba — glossary terms introduced by Bengal & the east (IN-BEN), English.
   Same shape as content/glossary.js; `match` lists the surface forms to look for in the English text. */
...
Object.assign(window.GLOSSARY, {
  ...
  'kosha': {
    term: 'Kosha',
    short: 'To fry something down slowly with very little liquid until the fat separates out.',
    long: 'A technique rather than a recipe. The pan is allowed to dry and start catching, a splash of water lifts the browned layer off the base, and the cycle repeats for the best part of an hour. Each round takes the onion a shade darker. Kosha mangsho is goat treated this way, and the name describes the method rather than the ingredients.',
    match: ['kosha']
  },
  'ilish': {
    term: 'Ilish',
